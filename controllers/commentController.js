...
const putCommentById = async (req, res) => await entityController.putEntityById(req, res, CommentModel, ["post"]);
const patchCommentById = async (req, res) => await entityController.patchEntityById(req, res, CommentModel, ["post"]);
